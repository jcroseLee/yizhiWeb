...
### 1.1 产品定位
易知是一个基于传统六爻推演理论的现代化 Web 平台，旨在为用户提供专业的推演服务、易学知识分享和实证案例学习。平台采用新中式学术风格设计，结合现代 Web 技术，打造沉浸式的易学体验。
