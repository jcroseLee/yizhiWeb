      ...
      return (
        <div key={node.id} className={`relative ${level > 0 ? 'ml-6 tree-line' : 'mb-1'}`}>
          ...
          >
             {/* Icon / Expander */}
             <div 
               className="mr-2 flex-shrink-0 w-5 h-5 flex items-center justify-center rounded hover:bg-stone-300/50 transition-colors"
      ...
      <div className="flex flex-col h-screen paper-texture text-stone-800">
        ...
        <header className="flex-none h-14 border-b border-stone-200/50 bg-[#F9F7F2]/80 backdrop-blur-md sticky top-0 z-40 px-6 lg:px-8 flex items-center justify-between transition-all duration-300">
           ...
           <div className="flex items-center gap-3">
              <Button variant="ghost" size="sm" className="h-8 text-stone-400 hover:text-stone-800 font-serif hover:bg-stone-100">
                 <Share2 className="w-3.5 h-3.5 mr-2" /> 分享图谱
              </Button>
           </div>
        </header>
        ...
        <div className="flex-1 flex overflow-hidden relative">
           ...
           <aside 
             className={`w-72 bg-transparent border-r border-stone-200/50 flex flex-col transition-transform duration-300 ease-in-out absolute lg:static h-full z-30 lg:translate-x-0 bg-[#F9F7F2] lg:bg-transparent ${isSidebarOpen ? 'translate-x-0 shadow-2xl lg:shadow-none' : '-translate-x-full'}`}
           >
           ...
           >
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 opacity-[0.03] pointer-events-none">
                  <Network className="w-[500px] h-[500px] text-stone-800" />
              </div>

              <div className="max-w-5xl mx-auto px-6 py-12 lg:px-12 lg:py-20 flex flex-col items-center justify-center min-h-[80%]">
                 
                 <div className="text-center w-full max-w-2xl space-y-8 animate-in zoom-in-95 duration-700 ease-out">
                    
                    {/* Hero Title */}
                    <div className="space-y-4">
                        <div className="inline-flex items-center justify-center p-3 bg-stone-100/50 rounded-full mb-2 shadow-sm">
                            <Sparkles className="w-6 h-6 text-[#C82E31]" />
                        </div>
                    ...
                    <div className="relative max-w-xl mx-auto w-full group">
                        ...
                        <div className="relative">
                            <Search className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-stone-400 group-focus-within:text-[#C82E31] transition-colors" />
                            <Input 
                                placeholder="搜索知识点、卦例、技法..." 
                                className="h-14 pl-12 pr-4 bg-white/80 backdrop-blur-sm border-stone-200 focus-visible:ring-[#C82E31]/20 focus-visible:border-[#C82E31] rounded-full shadow-lg shadow-stone-200/50 text-base transition-all hover:bg-white" 
                            />
                            <div className="absolute right-2 top-1/2 -translate-y-1/2 px-3 py-1 bg-stone-100 rounded-full text-xs text-stone-400 font-medium border border-stone-200 hidden sm:block">
                                ⌘ K
                            </div>
                        </div>
                    </div>
                    ...
                    {/* Navigation Cards */}
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 w-full pt-8">
                        {/* Card 1 */}
                        <div className="group relative p-6 bg-white border border-stone-200 rounded-xl hover:border-[#C82E31]/30 hover:shadow-[0_8px_30px_rgba(200,46,49,0.06)] transition-all duration-300 cursor-pointer overflow-hidden text-left">
                            <div className="absolute top-0 right-0 p-4 opacity-[0.05] group-hover:opacity-[0.1] transition-opacity transform group-hover:scale-110 duration-500">
                                <Layout className="w-24 h-24" />
                            </div>
                            <div className="w-10 h-10 rounded-lg bg-stone-50 border border-stone-100 flex items-center justify-center mb-4 group-hover:bg-[#C82E31] group-hover:text-white transition-colors duration-300">
                                <FileText className="w-5 h-5" />
                            </div>
                            <h3 className="text-lg font-bold font-serif text-stone-800 mb-2 group-hover:text-[#C82E31] transition-colors">易学通识</h3>
                        ...
                        <div className="group relative p-6 bg-white border border-stone-200 rounded-xl hover:border-[#C82E31]/30 hover:shadow-[0_8px_30px_rgba(200,46,49,0.06)] transition-all duration-300 cursor-pointer overflow-hidden text-left">
                            ...
                            <h3 className="text-lg font-bold font-serif text-stone-800 mb-2 group-hover:text-[#C82E31] transition-colors">分门别类</h3>
                            <p className="text-xs text-stone-500 leading-relaxed">
                        ...
                        <div className="group relative p-6 bg-white border border-stone-200 rounded-xl hover:border-[#C82E31]/30 hover:shadow-[0_8px_30px_rgba(200,46,49,0.06)] transition-all duration-300 cursor-pointer overflow-hidden text-left">
                            ...
                            <h3 className="text-lg font-bold font-serif text-stone-800 mb-2 group-hover:text-[#C82E31] transition-colors">分类占验</h3>
                            <p className="text-xs text-stone-500 leading-relaxed">
